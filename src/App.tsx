...
const onEditTodo = (id: string, text: string, description: string, date: string) => {
  setTodos((prevTodos) =>
    prevTodos.map((todo) =>
...
const selectedTodo = taskId ? todos.find((todo) => todo.id === taskId) : undefined;
...
onClick={
  ...
  <div className="todo-container">
    ...
    <TodoList onDeleteTodo={onDeleteTodo} onEditTodo={onEditTodo} onViewTodo={(id) => navigate(`/tasks/${id}`)} todos={filteredTodos}
